	...
	<?=form_open(base_url()."instructor/editarUsuario/{$usuario->id_usuario}", ['class'=>'form-horizontal']); ?>
	  <fieldset>
		...
		<div class="form-group">
			...
			<input type="hidden" id="pais" value="<?=$individuo->nacionalidad ?>">
			<select name="nacionalidad" class="form-control" id="paises">
...
<script>
	// Selecciona el pais en el dropdown de paises
	var pais = document.getElementById('pais').value;
	document.getElementById('paises').value = pais;
</script>
